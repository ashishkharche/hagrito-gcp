...
public class CreateTranscript {
    ...
    private static final String AUDIO_FILENAME = "src/main/resources/soundoftext-8000hz.wav";
    ...
    private static String createDocument(Docs service) throws IOException {
        Document doc = new Document().setTitle("3 DID IT WORK?: Transcript for " + AUDIO_FILENAME);
